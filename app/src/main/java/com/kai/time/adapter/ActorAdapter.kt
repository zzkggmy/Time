...
class ActorAdapter(val actorList: ArrayList<MovieDetailsBean.Data.Basic.Actors>, val onClick: (view: View, position: Int) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
